    ...
    <div className='flex flex-col sm:flex-row p-3 border border-cyan-800 justify-center items-center rounded-3xl text-center'>
      <div className='flex-1 justify-center flex flex-col'>
        ...
        <p className='text-gray-500 my-2'>
          ...
          back to school for my Master's degree, and you'll see Python, and
          more, but my main focus for now is ReactJS.
        </p>
        ...
        >
          ...
          >
            ...
            ScotCorm's GitHub Overview Page
          </a>
        </Button>
      </div>
